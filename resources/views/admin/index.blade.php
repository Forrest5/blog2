...
<div class="top_box">
	...
	<div class="top_right">
		<ul>
			<li>管理员：admin</li>
			<li><a href="{{url('admin/changePasswd')}}" target="main">修改密码</a></li>
			<li><a href="{{url('admin/quit')}}" onclick="return isQuit()">退出</a></li>
		</ul>
	</div>
</div>
<!--头部 结束-->
...
<div class="bottom_box">
	CopyRight © 2017. Powered By <a href="http://www.forrests.xyz">http://www.forrests.xyz</a>.
</div>
<!--底部 结束-->
<script>
	function isQuit() {
